...
export default function ProjectsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-20 border-b border-slate-100 overflow-hidden">
        ...
        <div className="container max-w-6xl mx-auto px-4">
          <div className="max-w-3xl space-y-6 animate-in fade-in slide-in-from-left-8 duration-1000">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 leading-[1.1]">
              From <span className="text-[#d74b16]">Requirement</span> <br />
              <span className="text-[#00072d]">to</span> <span className="text-[#d74b16]">Product</span>
            </h1>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-12 pb-6 border-b border-slate-200/60 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                ...
                {[1, 2, 3].map((i: number) => (
                  <div key={i} className="w-[3rem] h-[3rem] rounded-full border-2 border-white bg-slate-200 flex items-center justify-center overflow-hidden">
                    <div className="w-full h-full bg-[#00072d] flex items-center justify-center">
                        <span className="text-[8xl] font-bold text-[#fff]">0{i}</span>
                    </div>
                  </div>
                ))}
              </div>
              <p className="text-3xl font-semibold text-slate-900">
                All Featured Projects :  <span className="text-[#d74b16]">{PROJECTS.length} </span> 
              </p>
            </div>
